...
class HomeController extends GetxController {
  ...
  void opendialog({String? uuid}) {
    final task = pendingtask['monitoring'].firstWhere((task) => task['uuid'] == uuid);
    Get.defaultDialog(
...
Text(task['billboard_detail']['title'] ?? 'Untitled',
                    style: TextStyle(fontSize: 16,textBaseline: TextBaseline.alphabetic),
                    textAlign: TextAlign.center,
                  ),
                  Text(
                    task['billboard_detail']['location']['location'] ?? 'Untitled',
                    style: TextStyle(
