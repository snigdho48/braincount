      ...
      body: backgroundColorLinear(
        child: SizedBox(
          ...
          child: SingleChildScrollView(
                  padding: EdgeInsets.only(top: Get.height * .02,left: context.width * .05,right: context.width * .05),
                  child: Column(
                    ...
                    children: [
                      ...
                      tasklistCardDashboard(
                        status: 'Rejected',
                          text: 'Billboard1 at Gulshan', onPressed:  (){}),
                      tasklistCardDashboard(text: 'Billboard1 at Gulshan', onPressed: controller.opendialog,status: 'Pending'),
                                           tasklistCardDashboard(
